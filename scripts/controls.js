...
[...gameActions,...cameraActions,"snippet","pause-p1","pause-p2","Shift","Ctrl","Alt","c","v","x","y","z","BoxTool","LineTool","ActorTool","EraserTool","SelectTool","PropMenu","fullScreen","accept"],
["P1","R","\\",["up","w"],["right","d"],["down","s"],["left","a"],"]","[","=","`","F12","P1","P2","Shift","Ctrl","Alt","c","v","x","y","z","1","2","3","e","Space","q","f",["Enter","g"]]);
